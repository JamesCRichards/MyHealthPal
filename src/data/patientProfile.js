 ...
 * All careplans, recommendations, and schedules live here.
 */
export const PATIENT_PROFILE = {
  ...
  /** Care plans: condition-specific plans with goals. */
  carePlans: [
    {
      condition: 'Type 2 Diabetes',
      goals: ['Keep blood sugar in target range', 'Take Metformin with meals', 'Monitor glucose as advised'],
      notes: 'Diet and activity make a big difference.',
    },
    {
      condition: 'Congestive Heart Failure',
      goals: ['Take diuretic and beta-blocker as prescribed', 'Limit fluid and salt', 'Weigh daily', 'Report weight gain or shortness of breath'],
      notes: 'Consistency with meds and fluid restriction is key.',
    },
    {
      condition: 'Hypertension',
      goals: ['Take Lisinopril daily', 'Check blood pressure at home', 'Limit sodium'],
      notes: 'Same-time dosing helps.',
    },
  ],
  /** General recommendations (lifestyle, daily habits). */
  recommendations: [
  ...
  /** Schedules: what to do and when (for reminders and list view). */
  schedules: [
